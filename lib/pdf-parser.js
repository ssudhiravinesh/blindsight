/**
 * PDF Text Extraction Module for Blind-Sight
 * Uses Mozilla's pdf.js to extract text from PDF documents.
 */

import * as pdfjsLib from './pdf.min.mjs';

// Set the worker source to our local bundled worker
 ...
 * @returns {Promise<{success: boolean, text?: string, pageCount?: number, charCount?: number, error?: string}>}
 */
 ...
 * @returns {Promise<{success: boolean, url: string, text?: string, pageCount?: number, charCount?: number, error?: string}>}
 */
